...
if (isMobile) {
	...
	var t = document.createTextNode("Click on the photo.");      // Create a text node
	para.appendChild(t);                                          // Append the text to <p>
	modelImg.appendChild(para);

	tl1.fromTo(modelLeft,1, {ease: Power2.easeIn, y:-20, opacity: 0.1 },{y:0,opacity: 1})
	.fromTo(modelRight,1,{ease: Power2.easeIn, y:20,opacity: 0.1},{y:0,opacity: 1},'-=1');
